...
public class Select_phieuxuat_controller implements Initializable{
    ...
    private void loadData(int a,int b) {
		...
		tien.setCellValueFactory(new PropertyValueFactory<>("giaxuat"));
    ...
    public void setTextField(int a,String n,String nct,Timestamp timestamp) {
    	text_ma.setText("PX"+Integer.toString(a));
    	nv.setText(n);
    	ncc.setText(nct);
    	if(list!=null) {
       	 list.clear();	  
